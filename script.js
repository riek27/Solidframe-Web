...
})(); update my whole script.js please , so when the serivices drop down please when the drop down menu is click it will open all content with no redirect or open any other pages , and also when they close it will close them with no redirect to any others pages please, update it while keep other same also
